...
def load_mgac_options(stacked_feature_windows):
    stacked_feature_windows.setCurrentIndex(3)
...
def mgac(main_window):
    ...
    final_contour = mgac_functions.mgac_border_detection(polygon_region, image, iterations, threshold,
    ...
    mgac_functions.save_image_with_contours(image, final_contour, save_image_path)
